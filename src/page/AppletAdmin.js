...
export default memo(() => {
    ...
    // side item data
    const item = [
        { desc: "文章", icon: React.createElement(Icon, { type: "select" }), type: "button" },
        { desc: "表单", icon: React.createElement(Icon, { type: "picture" }), type: "picture" }
    ];
...
//# sourceMappingURL=AppletAdmin.js.map