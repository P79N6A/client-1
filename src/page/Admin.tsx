...
export default memo(() => {
  ...
  const item: Array<{ type: string; icon: object; desc: string }> = [
    { desc: "概览", icon: <Icon type="font-colors" />, type: "text" },
    { desc: "商铺", icon: <Icon type="wechat" />, type: "tex" },
    { desc: "商品", icon: <Icon type="select" />, type: "button" },
    { desc: "订单", icon: <Icon type="picture" />, type: "picture" },
    { desc: "客户", icon: <Icon type="shopping" />, type: "commodity" },
    { desc: "数据", icon: <Icon type="deployment-unit" />, type: "plugin" },
    { desc: "资产", icon: <Icon type="deployment-unit" />, type: "plugin" },
    { desc: "营销", icon: <Icon type="deployment-unit" />, type: "plugin" }
  ];
