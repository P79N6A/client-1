...
const ButtonEdit = memo((props: IRedux) => {
  ...
  const {
    ...
    btnImg,
    btnColor
  } = applet.pages[applet.pageId].ui[applet.uIndex];
      ...
      <TabPane tab="基础属性" key="1">
        <Form {...formItemLayout}>
          ...
          <Form.Item label="字体颜色">
            <Input
              value={color ? color : applet.theme}
                ...
                <Tooltip
                  title={
                    <TwitterPicker
                      css={styles.theme}
                      width={"240px"}
                      color={color ? color : applet.theme}
                      colors={[
                        "#DE443A",
                        "#3A82F8",
                        "#56BB37",
                ...
                >
                  <div
                    style={{
                      width: 15,
                      height: 15,
                      background: color ? color : applet.theme,
